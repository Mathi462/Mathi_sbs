...
import { CreateStoreComponent, DialogContentExampleDialog } from './create-store.component';
...
@NgModule({
  ...
  declarations: [
    ...
    entryComponents: [CreateStoreComponent, FieldErrorDisplayComponent,  DialogContentExampleDialog],
    providers: [
      FormBuilder,
    ApiService,
    HttpClientModule,
